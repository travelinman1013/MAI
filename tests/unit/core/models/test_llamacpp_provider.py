...
class TestLlamaCppHealthCheck:
    ...
    async def test_health_check_uses_settings(self):
        ...
        from src.core.utils.config import LlamaCppSettings

        custom_settings = LlamaCppSettings(
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with patch(
                ...
                result = await llamacpp_health_check(settings=custom_settings)

        assert result.base_url == "http://custom:8080/v1"
...
class TestCreateLlamaCppModel:
    ...
    def test_create_model_with_custom_settings(self):
        ...
        model = create_llamacpp_model(settings=custom_settings)
        assert model is not None


class TestCreateLlamaCppModelAsync:
    """Tests for create_llamacpp_model_async function."""
    ...
    async def test_create_model_with_auto_detect(self):
        ...
        with patch(
            ...
            "src.core.models.llamacpp_provider.llamacpp_health_check",
            new_callable=AsyncMock,
            ...
            model = await create_llamacpp_model_async(
    ...
    async def test_create_model_connection_error(self):
        ...
        with patch(
            ...
            with pytest.raises(ModelError) as exc_info:
                await create_llamacpp_model_async(
